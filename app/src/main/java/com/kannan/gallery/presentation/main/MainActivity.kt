...
import com.kannan.gallery.presentation.navigation.SetupNavGraph
import com.kannan.gallery.presentation.navigation.bottomnav.SetupBottomNavigation
...
class MainActivity : ComponentActivity() {
    ...
    private fun getStartDestination() =
        when (checkPermission()) {
            true -> NavigationScreen.MediaScreen
